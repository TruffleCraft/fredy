  ...
  try {
    ...
    if (listings.length > 0) {
      for (const listing of listings) {
        ...
        // The provider uses {-1, -1} as its "not found" sentinel.  Persisting
        // it would make the row look geocoded and falsely exclude it from area
        // filtering, so leave it retryable instead.
