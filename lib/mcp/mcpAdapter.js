...
export function createMcpServer() {
  ...
  // Listing triage writes stay opt-in, so a normal upstream-compatible deployment
  // keeps the read-only MCP surface unless an operator explicitly enables them.
